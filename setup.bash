#!/bin/bash
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='c25.conf'
CONFIGFOLDER='/root/.c25core'
COIN_DAEMON='c25d'
COIN_CLI='c25-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/c25core/c25/releases/download/c25-v2.5.0.1/c25-linux.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='c25'
COIN_EXPLORER='http://explorer.c25.website/'
COIN_PORT=12525
RPC_PORT=12552 
